...
def select_shallow_thinking_agent(provider) -> str:
    ...
    SHALLOW_AGENT_OPTIONS = {
        ...
        "openrouter": [
            ...
            ("Google: Gemini 2.0 Flash Thinking", "google/gemini-2.0-flash-thinking-exp:free"),
...
def select_deep_thinking_agent(provider) -> str:
    ...
    DEEP_AGENT_OPTIONS = {
        ...
        "openrouter": [
            ("DeepSeek V3 (Free) - 685B-parameter mixture-of-experts", "deepseek/deepseek-chat-v3-0324:free"),
            ("DeepSeek V3 - Latest flagship chat model", "deepseek/deepseek-chat-v3-0324"),
            ("Meta: Llama 3.1 70B Instruct", "meta-llama/llama-3.1-70b-instruct"),
